...
accommodation = ("What are some of your interests?" +
                 "I like swimming, biking, sports like basketball and soccer, "
                 "food, seafood, the beach, painting, and going out and going to concerts")
...
otherInfo = ("Add any other info that you think is important for the trip?" +
             "we are college students that want to have a fun vacation")


bard = BardCookies(cookie_dict=cookie_dict)
result_string = """Can you plan a trip based on all of these questions and answers:
                {destination}{city}{departure_date}{return_date}{budget}{accommodation}
                {activities}{activities}{people}{planned}{otherInfo}"Also can you plan
                 this trip in this order: ONLY 1 Daily schedule with links for each
                 activity and an estimated price for the activity for everyone(do
                 not provide more than 1 itinerary on the output), ONE A packing
                 list, after providing a daily activiy and packing list provide 10
                 hotel or airbnb reccomendation for the whole trip with links and
                 lastly 10 reccomended reasturant locations for the whole trip based
                 on the given information and location""".format(
...
print(bard.get_answer(result_string)['contents'])
